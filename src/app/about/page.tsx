      ...
      <section className='space-y-6'>
        ...
        <div className='space-y-4'>
          ...
          <p>
            ...
            eligendi dolor eius voluptatum, ratione repudiandae provident ad quo
            aut eaque rem minus iure quisquam! Nulla officia fugit eius nihil
            quia.
          </p>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias
            eveniet tempore porro ipsum vel! Alias sequi obcaecati excepturi ex
            dignissimos commodi, illum nam suscipit quo neque quibusdam amet sed
            ad fugiat non dolor libero fuga accusamus dolores voluptas deserunt
            dolorem iste perferendis. Itaque iste eum nemo, illo non repudiandae
            quia!
          </p>
        </div>
      </section>
